...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div style="background-color: #5BC0BE;" class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            @if (Route::has('login'))
    ...
    <script>
        var string = "Crie sua assinatura na Ocado e ganhe 15% de desconto em todos os produtos";
